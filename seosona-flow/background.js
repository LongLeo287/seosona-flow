...
// openRunWindow ĐÃ GỠ — nó chỉ được kích hoạt bởi message runWorkflow/runNode từ cầu nối
// website (đã gỡ), và nó mở run-window.html là asset chỉ có ở bản web. Workflow chạy trực tiếp
// từ bảng bên qua WorkflowExecutor.
...
chrome.runtime.onMessage.addListener((message, sender, sendResponse) => {
  ...
  // Cầu nối mã giới thiệu (affiliate) ĐÃ GỠ cùng cầu nối website — nó chỉ có nghĩa khi có
  // web-app đăng ký tài khoản, mà bản này không có tài khoản và không có backend.

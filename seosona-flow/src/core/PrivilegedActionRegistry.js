...
(function (global) {
  ...
  var KNOWN_ACTIONS = [
    ...
    "gemini:findOrCreateTab", "gemini:generateImage", "gemini:getTabInfo", "gemini:injectScript",
    "gemini:navigatedBroadcast", "gemini:submitAndWait", "gemini:tabClosed", "gen_image",
    "generate", "getBrowserZoom", "getEditingWorkflowId", "getFlowProjectContext",
    "getProviderApiConfigs", "getProviderConfigs", "getSettingsWindowId", "grok",
    "grok:abort", "grok:applySettings", "grok:applySettingsInline", "grok:checkLogin",
    "grok:checkStatus", "grok:closeTab", "grok:ensureActive", "grok:fetchImage",
    "grok:fetchMedia", "grok:findOrCreateTab", "grok:gen_progress", "grok:getTabInfo",
    "grok:injectScript", "grok:navigated", "grok:navigatedBroadcast", "grok:restoreFocus",
    "grok:setRatio", "grok:submitAndWait", "grok:tabClosed", "halt",
    "header", "hello", "hello_ack", "i2p:analyze",
    "i2p:cancel", "i2p:captureRegion", "i2p:checkAccess", "i2p:checkProviders",
    "i2p:fetchImage", "i2p:genOnFlow", "i2p:genToNode", "i2p:getConfig",
    "i2p:getCtxImageUrl", "i2p:invalidateConfig", "i2p:openApp", "i2p:openProviderLogin",
    "i2p:regionMode", "i2p:sendImageToGen", "i2p:setGenPrompt", "i2p:showCard",
    "i2p:uploadMode", "image", "importWorkflowTemplate", "integer",
    "interval", "keydown", "loadTemplateInEditor", "loadTemplatePreview",
    ...
    "openWebSpaces", "openWorkflowEditor", "openWorkflowTemplatePreview", "openWorkflowTemplatePreviewById",
    "pa:activateTab", "pa:generate", "pa:getConfig", "pa:getFormats",
    "pa:invalidateFormats", "payment:cancelled", "payment:completed", "payment:success",
    "ping", "pong", "pq:pauseJob", "pq:resumeJob",
    "pq:state_broadcast", "pq:stopAll", "pq:stopJob", "pq:trackerUpdate",
    "prepareDownloadRename", "progress", "projectContext", "prompt",
    "promptExecutionComplete", "promptProgress", "provider:textTask", "providerApiConfigUpdated",
    "providerConfigUpdated", "queryProviderTabs", "queue:pause_job", "queue:resume_job",
    "queue:stop_all", "queue:stop_job", "quota", "reinjectSlateBridge",
    "reportSelectorFailure", "requestCapturePermission", "restorePreviousTab", "result",
    "retry:status", "runEvents:list", "runEvents:markRead", "runEvents:record",
    ...
    "startCropOnActiveTab", "string", "success", "task",
    "templateCreated", "templateEditorClosed", "templateUpdated", "terminal",
    "text", "updateEditingWorkflowId", "updateProviderUrlsCache", "upload",
    "use", "video", "visualPicker:buildNode", "visualPicker:probeSelector",
    "wm:autoProcess", "wm:fetchImage", "workflowClonedFromShared", "workflowDeleted",
    "workflowEditorClosed", "workflowExecutionEvent", "workflowResults:appendRows", "workflowResults:createRun",
    "workflowResults:exportCsv", "workflowResults:getRun", "workflowResults:listRuns", "workflowResults:setStatus",
    "workflowSaved", "workflowTemplateImportRequested", "workflow_shared", "zoomGuard:disarm",
    "zoomGuard:recover",
  ];
